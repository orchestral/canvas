...
## Fixes namespace.
awk '{sub(/use {{ rootNamespace }}Http/,"use {{ rootNamespace }}\\Http")}1' storage/routing/controller.api.stub > storage/routing/temp.stub && mv storage/routing/temp.stub storage/routing/controller.api.stub
awk '{sub(/use DummyRootNamespaceHttp/,"use {{ rootNamespace }}\\Http")}1' storage/routing/controller.invokable.stub > storage/routing/temp.stub && mv storage/routing/temp.stub storage/routing/controller.invokable.stub
awk '{sub(/use {{ rootNamespace }}Http/,"use {{ rootNamespace }}\\Http")}1' storage/routing/controller.model.api.stub > storage/routing/temp.stub && mv storage/routing/temp.stub storage/routing/controller.model.api.stub
awk '{sub(/use {{ rootNamespace }}Http/,"use {{ rootNamespace }}\\Http")}1' storage/routing/controller.model.stub > storage/routing/temp.stub && mv storage/routing/temp.stub storage/routing/controller.model.stub
awk '{sub(/use {{ rootNamespace }}Http/,"use {{ rootNamespace }}\\Http")}1' storage/routing/controller.nested.api.stub > storage/routing/temp.stub && mv storage/routing/temp.stub storage/routing/controller.nested.api.stub
awk '{sub(/use {{ rootNamespace }}Http/,"use {{ rootNamespace }}\\Http")}1' storage/routing/controller.nested.stub > storage/routing/temp.stub && mv storage/routing/temp.stub storage/routing/controller.nested.stub
awk '{sub(/use {{ rootNamespace }}Http/,"use {{ rootNamespace }}\\Http")}1' storage/routing/controller.plain.stub > storage/routing/temp.stub && mv storage/routing/temp.stub storage/routing/controller.plain.stub
