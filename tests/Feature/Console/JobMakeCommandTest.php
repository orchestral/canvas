...
class JobMakeCommandTest extends TestCase
{
    ...
    {
        $this->artisan('make:job', ['name' => 'FooCreated', '--preset' => 'canvas'])
            ->assertExitCode(0);
    ...
    {
        $this->artisan('make:job', ['name' => 'FooCreated', '--sync' => true, '--preset' => 'canvas'])
            ->assertExitCode(0);
    ...
    {
        $this->artisan('make:job', ['name' => 'FooCreated', '--test' => true, '--preset' => 'canvas'])
            ->assertExitCode(0);
